			...
			<c:forEach var="emp" items="${listEmps }">
				<tr>
					...
					<td><a href="edit_employee?no=${emp.empno}"><img src="resources/images/edit.jpeg"
							height="30" width="30"></a> &nbsp;&nbsp;<a href="delete_employee?no=${emp.empno }"><img
...
<br><br>
<h1 style="color:red;text-align: center"><a href="add_employee"><img src="resources/images/add.jpeg"
